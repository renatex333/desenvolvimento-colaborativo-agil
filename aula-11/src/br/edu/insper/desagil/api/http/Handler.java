...
import br.edu.insper.desagil.api.http.exception.NotFoundException;
import br.edu.insper.desagil.api.http.exception.NotSupportedException;
import br.edu.insper.desagil.api.http.exception.ServerException;
...
public class Handler extends AbstractHandler {
	...
	public Handler() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
		...
		Reflections reflections = new Reflections("br.edu.insper.desagil.api");
